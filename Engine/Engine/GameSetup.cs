...
namespace Cardnell.Chess.Engine
{
    ...
    {
        public static List<Tuple<Piece, Position>> Classical => new List<Tuple<Piece, Position>>
        {
            ...
            new Tuple<Piece, Position>(new Piece(PieceColour.White, PieceType.Pawn), new Position(1, 5)),
            new Tuple<Piece, Position>(new Piece(PieceColour.White, PieceType.Pawn), new Position(1, 6)),
            new Tuple<Piece, Position>(new Piece(PieceColour.White, PieceType.Pawn), new Position(1, 7)),
            ...
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 0)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 1)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 2)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 3)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 4)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 5)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 6)),
            new Tuple<Piece, Position>(new Piece(PieceColour.Black, PieceType.Pawn), new Position(6, 7))
